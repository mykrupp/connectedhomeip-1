...
void DataSeriesValidator::OnAttributeData(const ReadClient * apReadClient, Optional<DataVersion> & aVersion,
...
void DataSeriesGenerator::Generate()
{
    ...
    for (auto & instruction : mInstructionList)
    {
        ...
        case ValidationInstruction::kListAttributeC_Error: {
            ...
            hasData           = false;
            callback->OnAttributeData(nullptr, version, path, &reader, status);
            break;
        }
